...
class SideBar:
    ...
    def social_media_buttons(self, align='center'):
        ...
        <div style="text-align: {align}">
            <p>
                <a href={settings.config['social_media']['github']}>
                ...
                <a href={settings.config['social_media']['linkedin']}>
                    <button type="button" class="btn btn-success">
                ...
                <a href={settings.config['social_media']['tweeter']}>
                    <button type="button" class="btn btn-success">
                ...
                <a href={settings.config['social_media']['youtube']}>
                    <button type="button" class="btn btn-success">
