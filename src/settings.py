...
class Settings:
    ...
    def site_footer(self):
        '''
        Site footer of the web page, footer contains
        copyright disclaimer and rendered buttons to
        project components repository and streamlit
        documentation
        '''
        ...
        <p style="text-align: center; font-size: 15px">
            <br>
                ...
                </svg> {self.config['main']['copyright']}</br>
